...
(function () {
  ...
  var ES = {
    ...
    'exp.palace.r2.b6': 'Uso de metodologías ágiles en el proceso de desarrollo.',

    'exp.enacment.title': 'Software Developer',
    'exp.enacment.date': 'feb. 2022 — mar. 2024 · 2 años 2 meses',
    ...
    'exp.enacment.b4': 'Participación en procesos de mejora continua (Agile).',
    'exp.enacment.b5': 'Gestión y mantenimiento de aplicaciones productivas.',
    'exp.enacment.b6': 'Procesos backend con Google Cloud Functions, AWS Lambda y bases de datos relacionales y no relacionales.',
    'exp.enacment.b7': 'Generación de reportes (Looker Studio, Power BI) y paneles de administración.',

    'exp.cnj.title': 'Technical Writer',
    'exp.cnj.date': 'ago. 2023 — abr. 2024 · 9 meses',
