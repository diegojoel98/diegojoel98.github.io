...
(function () {
  ...
  var ES = {
    ...
    'exp.palace.tenure': '2 años 6 meses',
    ...
    'post.4.date': 'dic. 2024',
    'post.4.t': '¿Qué es un microfrontend y por qué debes conocerlo?',
    'post.4.d': 'La introducción a microfrontends que me hubiera gustado leer primero.',
    'post.5.date': 'mar. 2025',
    'post.5.t': 'Cómo instalar WordPress localmente y crear sitios en tu propia máquina',
    'post.5.d': 'Un setup local práctico para construir y romper sitios WordPress sin riesgo.',
    ...
    'misc.6t': 'Fundamentos de Git y GitHub · Bootstrap · HTML y CSS',
